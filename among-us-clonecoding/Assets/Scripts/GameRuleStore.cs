...
public struct GameRuleData
{
    ...
    public ETaskBarUpates taskBarUpates;
...
public class GameRuleStore : NetworkBehaviour
{
    ...
    private ETaskBarUpates taskBarUpates;
    [SerializeField]
    private Text taskBarUpatesText;
    public void SetTaskBarUpdates_Hook(ETaskBarUpates _, ETaskBarUpates value)
    {
        taskBarUpatesText.text = value.ToString();
        UpdateGameRuleOverview();
    }
    public void OnChangeTaskBarUpdates(bool isPlus)
    {
        taskBarUpates = (ETaskBarUpates)Mathf.Clamp((int)taskBarUpates + (isPlus ? 1 : -1), 0, 2);
        isRecommendRule = false;
        isRecommendRuleToggle.isOn = false;
    }
    ...
    public void UpdateGameRuleOverview()
    {
        ...
        sb.Append($"긴급 회의 쿹타임: {emergencyMeetingsCooldown}\n");
        ...
        sb.Append($"Task Bar Updates: {taskBarUpates}\n");
